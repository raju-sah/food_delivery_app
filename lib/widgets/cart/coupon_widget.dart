    ...
    showCupertinoDialog(
        ...
        builder: (BuildContext context){
          return CupertinoAlertDialog(
            ...
            content: Text('This discount coupon $code you have entered is $validity. Please try with valid Coupon code'),
            actions: [
              FlatButton(
                  child: Text('OK',style: TextStyle(color: Colors.deepOrangeAccent,fontWeight: FontWeight.bold),),
                onPressed: (){
